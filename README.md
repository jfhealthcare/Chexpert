...
<table>
  <tr>
    <td> </td>
		<td>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;original&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
		<td><a  style="font-size:14px" href="config/example_AVG.json">AVG (dev mAUC:0.895)</a></td>
    <td><a style="font-size:14px" href="config/example_LSE.json">LSE (dev mAUC:0.896)</a></td>
    <td><a  style="font-size:14px" href="config/example_PROB.json">PROB (dev mAUC:0.896)</a></td>
	<tr>
  <tr>
    <td>Cardiomegaly </td>
