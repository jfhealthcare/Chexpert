...
||&emsp;&emsp;&emsp;&emsp; original &emsp;&emsp;&emsp;&emsp;&emsp; [AVG (Best dev mAUC:0.895)](config/example_AVG.json) &emsp; [LSE (Best dev mAUC:0.896)](config/example_LSE.json) &emsp; [PROB (Best dev mAUC:0.896)](config/example_PROB.json)|
|------|-----|
